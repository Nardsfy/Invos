        ...
        <ul class="navbar-nav">
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="masterNavbar">
                    <a class="dropdown-item" href="home.php?module=masterproduct">Product</a>
                    <a class="dropdown-item" href="home.php?module=mastersupplier">Supplier</a>
                </div>
            </li>
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="viewNavbar">
                    <a class="dropdown-item" href="home.php?module=viewproduct">Product</a>
                    <a class="dropdown-item" href="home.php?module=viewsupplier">Supplier</a>
                    <a class="dropdown-item" href="home.php?module=viewstock">Stock</a>
                    <a class="dropdown-item" href="home.php?module=history">History</a>
                </div>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="home.php?module=transaction">Transaction</a>
            </li>
        </ul>
